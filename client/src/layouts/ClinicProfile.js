    ...
    try {
      ...
      setAppointments(
        response.data.filter(
          (app) => app.deleted == false && app.status == "FREE"
        )
      );
    } catch (error) {
      ...
      <div className="flex-container">
        <div className="flex-child">
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div className="hospital-info">
              ...
              <table style={{ marginTop: "30px" }}>
                <tbody>
                  <tr>
                    <td>
                      <label htmlFor="name" className="label-hospital">
                        Name:
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <label htmlFor="description" className="label-hospital">
                        Description:
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      {" "}
                      <label htmlFor="rating" className="label-hospital">
                        Rating:
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      {" "}
                      <label htmlFor="addr" className="label-hospital">
                        Address:
                      </label>
                    </td>
                    <td>
                      {" "}
                      <input
                        defaultValue={clinic.addressName}
                        onChange={handleFormInputChange("addressName")}
                        id="rating"
                        type="text"
                        className="input-hospital"
                        disabled={disabled ? "disabled" : ""}
            ...
            <div
              className="flex-child right-part"
          ...
          <div>
            ...
            >
              Free appointments at this clinic
            </h1>
                ...
                {appointments
                  ...
                  .map((app) => (
                    <AppointmentRow
                      ...
                      doctor={app.doctor.user}
                      nurse={app.nurse.user}
                      price={app.price}
                      deleted={app.deleted}
                    />
                  ))}

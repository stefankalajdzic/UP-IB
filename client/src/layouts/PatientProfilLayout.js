...
const PatientProfilLayout = () => {
  ...
  if (!patient) {
    return (
      <div style={{ textAlign: "center" }}>Can't find your profile :/</div>
    );
  }
  ...
  return (
    <>
      ...
      <div>
        <label htmlFor="email" className="label-profilInfo">
          Email:
        </label>
        <input
          id="email"
          type="text"
          value={patient.userDto.email}
          className="input-profilInfo "
          disabled
        />

        <label htmlFor="name" className="label-profilInfo">
          Name:
        </label>
        <input
          id="name"
          type="text"
          value={patient.userDto.name}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "name")}
        />

        <label htmlFor="surname" className="label-profilInfo">
          Surame:
        </label>
        <input
          id="surname"
          type="text"
          value={patient.userDto.lastName}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "lastName")}
        />

        <label htmlFor="address" className="label-profilInfo">
          Home address:
        </label>
        <input
          id="address"
          type="text"
          value={patient.userDto.address}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "address")}
        />

        <label htmlFor="city" className="label-profilInfo">
          City:
        </label>
        <input
          id="city"
          type="text"
          value={patient.userDto.city}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "city")}
        />

        <label htmlFor="state" className="label-profilInfo">
          State:
        </label>
        <input
          id="state"
          type="text"
          value={patient.userDto.country}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "country")}
        />

        <label htmlFor="contact" className="label-profilInfo">
          Contact:
        </label>
        <input
          id="contact"
          type="text"
          value={patient.userDto.phoneNumber}
          className="input-profilInfo "
          disabled={disabled ? "disabled" : ""}
          onChange={(event) => changeInputHandler(event, "phoneNumber")}
        />

        <label htmlFor="lbo" className="label-profilInfo">
          LBO:
        </label>
        <input
          id="lbo"

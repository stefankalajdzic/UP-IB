    ...
    <>
      ...
      >
        <div className="register-form">
          ...
          <input
            onChange={handleFormInputChangeUser("email")}
            id="email"
            type="text"
          ...
          <input
            ...
            onChange={handleFormInputChangeUser("password")}
            className="input-register"
          />
          ...
          <input
            onChange={handleFormInputChangeUser("name")}
            id="name"
            type="text"
          ...
          <input
            onChange={handleFormInputChangeUser("lastName")}
            id="surname"
            type="text"
          ...
          <input
            onChange={handleFormInputChangeUser("address")}
            id="address"
            type="text"
          ...
          <input
            onChange={handleFormInputChangeUser("city")}
            id="city"
            type="text"
          ...
          <input
            onChange={handleFormInputChangeUser("country")}
            id="state"
            type="text"
          ...
          <input
            onChange={handleFormInputChangeUser("phoneNumber")}
            id="contact"
            type="text"
          ...
          <label htmlFor="lbo" className="label-register">
            LBO:
          </label>
          <input
            onChange={handleFormInputChange("lbo")}
            id="lbo"
            type="text"
            placeholder="enter your LBO here"
            className="input-register"
          />

          <button onClick={sendData} className="submit-register">
            Submit
          </button>
          {/*</form>*/}
        </div>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            You have successfully sent a registering request. Wait for our
            clinic administrator to approve it, before you can use this profile.
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          {/*onClick={handleClose}*/}
